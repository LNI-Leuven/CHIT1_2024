...
### Figure 1A-D & Supplementary table 2: Correlations between CSF biomarkers -----------------------------
```{r}
## Variables
...
### Table 2: Association of CHIT1 at diagnosis with multi-time point EDSS scores at follow-up -----------------------------
## Install packages
```{r}
